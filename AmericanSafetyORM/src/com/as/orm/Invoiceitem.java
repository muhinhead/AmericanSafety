...
public class Invoiceitem extends DbObject  {
    ...
    public Invoiceitem(Connection connection) {
        ...
        setColumnNames(new String[]{"invoiceitem_id", "invoice_id", "item_id", "qty", "price", "updated_at", "created_at"});
    }

    public Invoiceitem(Connection connection, Integer invoiceitemId, Integer invoiceId, Integer itemId, Integer qty, Double price, Timestamp updatedAt, Timestamp createdAt) {
        super(connection, "invoiceitem", "invoiceitem_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT invoiceitem_id,invoice_id,item_id,qty,price,updated_at,created_at FROM invoiceitem WHERE invoiceitem_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO invoiceitem ("+(getInvoiceitemId().intValue()!=0?"invoiceitem_id,":"")+"invoice_id,item_id,qty,price,updated_at,created_at) values("+(getInvoiceitemId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE invoiceitem " +
                    "SET invoice_id = ?, item_id = ?, qty = ?, price = ?, updated_at = ?, created_at = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT invoiceitem_id,invoice_id,item_id,qty,price,updated_at,created_at FROM invoiceitem " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Invoiceitem(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),new Integer(rs.getInt(4)),rs.getDouble(5),rs.getTimestamp(6),rs.getTimestamp(7)));
                dbObj.setNew(false);
            }
        } finally {
            try {
