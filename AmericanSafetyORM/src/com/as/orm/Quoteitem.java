...
public class Quoteitem extends DbObject  {
    ...
    public Quoteitem(Connection connection) {
        ...
        setColumnNames(new String[]{"quoteitem_id", "quote_id", "item_id", "qty", "price", "updated_at", "created_at"});
    }

    public Quoteitem(Connection connection, Integer quoteitemId, Integer quoteId, Integer itemId, Integer qty, Double price, Timestamp updatedAt, Timestamp createdAt) {
        super(connection, "quoteitem", "quoteitem_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT quoteitem_id,quote_id,item_id,qty,price,updated_at,created_at FROM quoteitem WHERE quoteitem_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO quoteitem ("+(getQuoteitemId().intValue()!=0?"quoteitem_id,":"")+"quote_id,item_id,qty,price,updated_at,created_at) values("+(getQuoteitemId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE quoteitem " +
                    "SET quote_id = ?, item_id = ?, qty = ?, price = ?, updated_at = ?, created_at = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT quoteitem_id,quote_id,item_id,qty,price,updated_at,created_at FROM quoteitem " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Quoteitem(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),new Integer(rs.getInt(4)),rs.getDouble(5),rs.getTimestamp(6),rs.getTimestamp(7)));
                dbObj.setNew(false);
            }
        } finally {
            try {
