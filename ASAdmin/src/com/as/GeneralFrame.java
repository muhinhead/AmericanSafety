...
//    protected JMenu filterMenu;
    ...
    public GeneralFrame(String title, IMessageSender exch, boolean isVisible) {
        super(title);
        addWindowListener(this);
        setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
        this.exchanger = exch;
        fillContentPane();
        float width = Float.valueOf(ASAdmin.readProperty("WindowWidth", "0.8"));
        float height = Float.valueOf(ASAdmin.readProperty("WindowHeight", "0.8"));
...
//    }
    ...
    protected static String adjustSelect(String filterQuery, String from, String select) {
...
//            from = from + "where ";
//        }
        newSelect = select + (includeWhere ? " and " : " where ") + filterQuery;
