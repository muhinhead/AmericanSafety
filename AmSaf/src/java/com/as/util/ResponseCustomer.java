...
public class ResponseCustomer implements Serializable {
    ...
    private Collection<ResponseCustomersContact> contacts;
     ...
     * @return the contacts
     */
    public Collection<ResponseCustomersContact> getContacts() {
        return contacts;
    }
     ...
     */
    public void setContacts(Collection<ResponseCustomersContact> contacts) {
