...
public abstract class EditPanelWithPhoto extends RecordEditPanel {
    ...
    protected static void exportDocImage(byte[] imageData) {
        JFileChooser chooser = new JFileChooser(ASAdmin.readProperty("imagedir", "./"));
    ...
    protected JComponent getRightUpperPanel() {
        ...
        if (picPanel == null) {
            ...
            picPanel.setPreferredSize(new Dimension(300, picPanel.getPreferredSize().height));
        }
        return rightPanel;
    }
    ...
    private void setPhoto() {
        ...
        imagePanel.setToolTipText("Right click for menu");
        picPanel.setVisible(true);
    }
