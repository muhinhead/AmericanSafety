...
public class ResponseDocumentList implements Serializable {
    ...
    private Long id;
    private Collection<ResponseDocument> response;
     ...
     * @return the response
     */
    public Collection<ResponseDocument> getResponse() {
        return response;
    }
     ...
     */
    public void setResponse(Collection<ResponseDocument> response) {
