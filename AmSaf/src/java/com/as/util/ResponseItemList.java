...
public class ResponseItemList implements Serializable {
    ...
    private Long id;
    private Collection<ResponseItem> response;
    private String[] errorMsg;

    public ResponseItemList() {
    }
    
    public ResponseItemList(Collection<Item> itemsList, String[] errmsg) {
     ...
     * @return the response
     */
    public Collection<ResponseItem> getResponse() {
        return response;
    }
     ...
     */
    public void setResponse(Collection<ResponseItem> response) {
