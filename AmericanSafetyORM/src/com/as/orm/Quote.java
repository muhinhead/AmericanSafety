...
public class Quote extends DbObject implements IDocument {
    ...
    public Quote(Connection connection) {
        ...
        setColumnNames(new String[]{"quote_id", "location", "contractor", "customer_id", "contact_id", "rig_tank_eq", "discount", "tax_proc", "po_type_id", "po_number", "date_in", "signature", "updated_at", "created_at", "created_by"});
    }

    public Quote(Connection connection, Integer quoteId, String location, String contractor, Integer customerId, Integer contactId, String rigTankEq, Double discount, Double taxProc, Integer poTypeId, String poNumber, Date dateIn, Object signature, Timestamp updatedAt, Timestamp createdAt, Integer createdBy) {
        super(connection, "quote", "quote_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT quote_id,location,contractor,customer_id,contact_id,rig_tank_eq,discount,tax_proc,po_type_id,po_number,date_in,signature,updated_at,created_at,created_by FROM quote WHERE quote_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                quote.setPoTypeId(new Integer(rs.getInt(9)));
                quote.setPoNumber(rs.getString(10));
                quote.setDateIn(rs.getDate(11));
                quote.setSignature(rs.getObject(12));
                quote.setUpdatedAt(rs.getTimestamp(13));
                quote.setCreatedAt(rs.getTimestamp(14));
                quote.setCreatedBy(new Integer(rs.getInt(15)));
                quote.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO quote ("+(getQuoteId().intValue()!=0?"quote_id,":"")+"location,contractor,customer_id,contact_id,rig_tank_eq,discount,tax_proc,po_type_id,po_number,date_in,signature,updated_at,created_at,created_by) values("+(getQuoteId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE quote " +
                    "SET location = ?, contractor = ?, customer_id = ?, contact_id = ?, rig_tank_eq = ?, discount = ?, tax_proc = ?, po_type_id = ?, po_number = ?, date_in = ?, signature = ?, updated_at = ?, created_at = ?, created_by = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT quote_id,location,contractor,customer_id,contact_id,rig_tank_eq,discount,tax_proc,po_type_id,po_number,date_in,signature,updated_at,created_at,created_by FROM quote " +
