...
public class Order extends DbObject implements IDocument {
    ...
    public Order(Connection connection) {
        ...
        setColumnNames(new String[]{"order_id", "location", "contractor", "customer_id", "contact_id", "rig_tank_eq", "discount", "tax_proc", "po_type_id", "po_number", "date_in", "date_out", "signature", "updated_at", "created_at", "created_by"});
    }

    public Order(Connection connection, Integer orderId, String location, String contractor, Integer customerId, Integer contactId, String rigTankEq, Double discount, Double taxProc, Integer poTypeId, String poNumber, Date dateIn, Date dateOut, Object signature, Timestamp updatedAt, Timestamp createdAt, Integer createdBy) {
        super(connection, "order", "order_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT order_id,location,contractor,customer_id,contact_id,rig_tank_eq,discount,tax_proc,po_type_id,po_number,date_in,date_out,signature,updated_at,created_at,created_by FROM `order` WHERE order_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                order.setPoTypeId(new Integer(rs.getInt(9)));
                order.setPoNumber(rs.getString(10));
                order.setDateIn(rs.getDate(11));
                order.setDateOut(rs.getDate(12));
                order.setSignature(rs.getObject(13));
                order.setUpdatedAt(rs.getTimestamp(14));
                order.setCreatedAt(rs.getTimestamp(15));
                order.setCreatedBy(new Integer(rs.getInt(16)));
                order.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO `order` ("+(getOrderId().intValue()!=0?"order_id,":"")+"location,contractor,customer_id,contact_id,rig_tank_eq,discount,tax_proc,po_type_id,po_number,date_in,date_out,signature,updated_at,created_at,created_by) values("+(getOrderId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE `order` " +
                    "SET location = ?, contractor = ?, customer_id = ?, contact_id = ?, rig_tank_eq = ?, discount = ?, tax_proc = ?, po_type_id = ?, po_number = ?, date_in = ?, date_out = ?, signature = ?, updated_at = ?, created_at = ?, created_by = ?" + 
            ...
            try {
                ...
                ps.setObject(8, getPoTypeId());
                ps.setObject(9, getPoNumber());
                ps.setObject(10, getDateIn());
                ps.setObject(11, getDateOut());
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT order_id,location,contractor,customer_id,contact_id,rig_tank_eq,discount,tax_proc,po_type_id,po_number,date_in,date_out,signature,updated_at,created_at,created_by FROM `order` " +
    ...
    public Object[] getAsRow() {
        ...
        columnValues[8] = getPoTypeId();
        columnValues[9] = getPoNumber();
        columnValues[10] = getDateIn();
        columnValues[11] = getDateOut();
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setPoTypeId(Integer.parseInt(flds[8]));
        } catch(NumberFormatException ne) {
            setPoTypeId(null);
        }
        setPoNumber(flds[9]);
        setDateIn(toDate(flds[10]));
        setDateOut(toDate(flds[11]));
