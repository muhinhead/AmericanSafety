...
public class ResponseStampsList implements Serializable {
    ...
    private Long id;
    private List<ResponseStamp> response;
    ...
    public ResponseStampsList(List<Stamps> stampsList, String[] errmsg) {
        ...
        if (stampsList!=null) {
            response = new ArrayList<ResponseStamp>(stampsList.size());
            for (Stamps stamps : stampsList) {
                response.add(new ResponseStamp(stamps));
            }
        }
        setErrorMsg(errmsg);
    }
     ...
     * @return the response
     */
    public List<ResponseStamp> getResponse() {
        return response;
    }
     ...
     */
    public void setResponse(List<ResponseStamp> response) {
