...
public class ResponseCustomerList implements Serializable {
    ...
    private Long id;
    private Collection<ResponseCustomer> response;
    ...
    public ResponseCustomerList(Collection<Customer> custList, String[] errList) {
        if (custList != null) {
     ...
     * @return the response
     */
    public Collection<ResponseCustomer> getResponse() {
        return response;
    }
     ...
     */
    public void setResponse(Collection<ResponseCustomer> response) {
